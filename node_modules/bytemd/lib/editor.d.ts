...
export declare type EditorUtils = ReturnType<typeof createEditorUtils>;
...
export declare function getBuiltinActions(locale: BytemdLocale, plugins: BytemdPlugin[], uploadImages: EditorProps['uploadImages']): BytemdAction[];
