...
// node_modules/gemoji/name-to-emoji.json
var require_name_to_emoji = __commonJS({
  "node_modules/gemoji/name-to-emoji.json"(exports, module) {
    module.exports = {
      "100": "\u{1F4AF}",
      "1234": "\u{1F522}",
      grinning: "\u{1F600}",
...
var require_remark_gemoji = __commonJS({
  "node_modules/remark-gemoji/index.js"(exports, module) {
    "use strict";
    var gemoji2emoji = require_name_to_emoji();
    var visit = require_unist_util_visit();
    module.exports = gemoji2;
    var find = /:(\+1|[-\w]+):/g;
...
// node_modules/@bytemd/plugin-gemoji/dist/index.esm.js
var import_remark_gemoji = __toModule(require_remark_gemoji());
function gemoji() {
  return {
    remark: (u) => u.use(import_remark_gemoji.default)
  };
}

// dep:@bytemd_plugin-gemoji
var bytemd_plugin_gemoji_default = gemoji;
export {
  bytemd_plugin_gemoji_default as default
};
//# sourceMappingURL=@bytemd_plugin-gemoji.js.map
