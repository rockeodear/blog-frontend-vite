...
var require_matters = __commonJS({
  "node_modules/micromark-extension-frontmatter/lib/matters.js"(exports, module) {
...
var require_syntax = __commonJS({
  "node_modules/micromark-extension-frontmatter/lib/syntax.js"(exports, module) {
    module.exports = create;
    var matters = require_matters();
...
var require_micromark_extension_frontmatter = __commonJS({
  "node_modules/micromark-extension-frontmatter/index.js"(exports, module) {
...
var require_from_markdown = __commonJS({
  "node_modules/mdast-util-frontmatter/from-markdown.js"(exports, module) {
...
var require_to_markdown = __commonJS({
  "node_modules/mdast-util-frontmatter/to-markdown.js"(exports, module) {
...
var require_remark_frontmatter = __commonJS({
  "node_modules/remark-frontmatter/index.js"(exports, module) {
    "use strict";
    var syntax = require_micromark_extension_frontmatter();
    var fromMarkdown = require_from_markdown();
    var toMarkdown = require_to_markdown();
    module.exports = frontmatter2;
    function frontmatter2(options) {
      var data = this.data();
...
// node_modules/@bytemd/plugin-frontmatter/dist/index.esm.js
var import_remark_frontmatter = __toModule(require_remark_frontmatter());
var import_js_yaml = __toModule(require_js_yaml2());
function frontmatter({ onError } = {}) {
  return {
    remark: (p) => p.use(import_remark_frontmatter.default).use(() => (tree, file) => {
      const fisrtNode = tree.children[0];
      if ((fisrtNode === null || fisrtNode === void 0 ? void 0 : fisrtNode.type) !== "yaml")
        return;
      try {
        file.frontmatter = (0, import_js_yaml.safeLoad)(fisrtNode.value);
      } catch (err) {
...
// dep:@bytemd_plugin-frontmatter
var bytemd_plugin_frontmatter_default = frontmatter;
export {
  bytemd_plugin_frontmatter_default as default
};
//# sourceMappingURL=@bytemd_plugin-frontmatter.js.map
